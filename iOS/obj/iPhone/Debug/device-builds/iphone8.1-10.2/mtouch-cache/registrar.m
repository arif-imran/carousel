...
static CGSize native_to_managed_trampoline_117 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UICollectionView * p0, UICollectionViewLayout * p1, NSIndexPath * p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_118 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UICollectionView * p0, UICollectionViewCell * p1, NSIndexPath * p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static NSInteger native_to_managed_trampoline_119 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UICollectionView * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "CustomerPortal.iOS.AppDelegate, CustomerPortal.iOS", "FinishedLaunching");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_9 (self, _cmd, &managed_method, "CustomerPortal.iOS.AppDelegate, CustomerPortal.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation Xamarin_Forms_Platform_CarouselViewController_Cell { } 
	...
	-(id) initWithFrame:(CGRect)p0
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_106 (self, _cmd, &managed_method, p0, "CoreGraphics.CGRect, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController+Cell, Xamarin.Forms.CarouselView", ".ctor", &call_super);
		if (call_super && rv) {
			struct objc_super super = {  rv, [UICollectionViewCell class] };
			rv = ((id (*)(objc_super*, SEL, CGRect)) objc_msgSendSuper) (&super, @selector (initWithFrame:), p0);
		}
...
@implementation Xamarin_Forms_Platform_CarouselViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_117 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UICollectionView, Xamarin.iOS", "UIKit.UICollectionViewLayout, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "GetSizeForItem");
	}

	-(void) collectionView:(UICollectionView *)p0 didEndDisplayingCell:(UICollectionViewCell *)p1 forItemAtIndexPath:(NSIndexPath *)p2
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_118 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UICollectionView, Xamarin.iOS", "UIKit.UICollectionViewCell, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "CellDisplayingEnded");
	}

	-(void) collectionView:(UICollectionView *)p0 willDisplayCell:(UICollectionViewCell *)p1 forItemAtIndexPath:(NSIndexPath *)p2
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_118 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UICollectionView, Xamarin.iOS", "UIKit.UICollectionViewCell, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "WillDisplayCell");
	}

	-(NSInteger) numberOfSectionsInCollectionView:(UICollectionView *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_119 (self, _cmd, &managed_method, p0, "UIKit.UICollectionView, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "NumberOfSections");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_114 (self, _cmd, &managed_method, p0, p1, "UIKit.UICollectionView, Xamarin.iOS", "System.nint, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "GetItemsCount");
	}

	-(UICollectionViewCell *) collectionView:(UICollectionView *)p0 cellForItemAtIndexPath:(NSIndexPath *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_113 (self, _cmd, &managed_method, p0, p1, "UIKit.UICollectionView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Forms.Platform.CarouselViewController, Xamarin.Forms.CarouselView", "GetCell");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "CustomerPortal.iOS.AppDelegate, CustomerPortal.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [1].handle = objc_getClass ("UICollectionViewLayout");
	__xamarin_class_map [2].handle = objc_getClass ("UICollectionViewTransitionLayout");
	...
	__xamarin_class_map [82].handle = objc_getClass ("UITableViewFocusUpdateContext");
	__xamarin_class_map [83].handle = objc_getClass ("UITableViewRowAction");
	...
	__xamarin_class_map [99].handle = objc_getClass ("UICollectionViewFocusUpdateContext");
	...
	__xamarin_class_map [105].handle = objc_getClass ("UICollectionViewController");
	__xamarin_class_map [106].handle = objc_getClass ("UITextField");
	...
	__xamarin_class_map [128].handle = objc_getClass ("UISwipeGestureRecognizer");
	__xamarin_class_map [129].handle = objc_getClass ("UIScreenEdgePanGestureRecognizer");
	...
	__xamarin_class_map [139].handle = objc_getClass ("UIKit_UIGestureRecognizer__UIGestureRecognizerDelegate");
	__xamarin_class_map [140].handle = objc_getClass ("__UIGestureRecognizerToken");
	__xamarin_class_map [141].handle = objc_getClass ("__UIGestureRecognizerParameterlessToken");
	__xamarin_class_map [142].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	...
	__xamarin_class_map [164].handle = [Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 class];
	__xamarin_class_map [165].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer_2 class];
	__xamarin_class_map [166].handle = [Xamarin_Forms_Platform_iOS_ViewRenderer class];
	__xamarin_class_map [167].handle = [Xamarin_Forms_Platform_iOS_CellTableViewCell class];
	__xamarin_class_map [168].handle = [Xamarin_Forms_Platform_iOS_ActivityIndicatorRenderer class];
	__xamarin_class_map [169].handle = [Xamarin_Forms_Platform_iOS_BoxRenderer class];
	__xamarin_class_map [170].handle = [Xamarin_Forms_Platform_iOS_NoCaretField class];
	__xamarin_class_map [171].handle = [Xamarin_Forms_Platform_iOS_EditorRenderer class];
	__xamarin_class_map [172].handle = [Xamarin_Forms_Platform_iOS_EntryRenderer class];
	__xamarin_class_map [173].handle = [Xamarin_Forms_Platform_iOS_FrameRenderer class];
	__xamarin_class_map [174].handle = [Xamarin_Forms_Platform_iOS_LabelRenderer class];
	__xamarin_class_map [175].handle = [Xamarin_Forms_Platform_iOS_HeaderWrapperView class];
	__xamarin_class_map [176].handle = [Xamarin_Forms_Platform_iOS_FormsUITableViewController class];
	__xamarin_class_map [177].handle = [Xamarin_Forms_Platform_iOS_ProgressBarRenderer class];
	__xamarin_class_map [178].handle = [Xamarin_Forms_Platform_iOS_ScrollViewRenderer class];
	__xamarin_class_map [179].handle = [Xamarin_Forms_Platform_iOS_SearchBarRenderer class];
	__xamarin_class_map [180].handle = [Xamarin_Forms_Platform_iOS_SliderRenderer class];
	__xamarin_class_map [181].handle = [Xamarin_Forms_Platform_iOS_StepperRenderer class];
	__xamarin_class_map [182].handle = [Xamarin_Forms_Platform_iOS_SwitchRenderer class];
	__xamarin_class_map [183].handle = [Xamarin_Forms_Platform_iOS_TabbedRenderer class];
	...
	__xamarin_class_map [199].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_PrimaryToolbarItem class];
	...
	__xamarin_class_map [210].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_ParentingViewController class];
	__xamarin_class_map [211].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer class];
	__xamarin_class_map [212].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer_Delegate class];
	__xamarin_class_map [213].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer class];
	__xamarin_class_map [214].handle = [Xamarin_Forms_Platform_iOS_PageRenderer class];
	__xamarin_class_map [215].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer_ChildViewController class];
	__xamarin_class_map [216].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer class];
	__xamarin_class_map [217].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer_PickerSource class];
	...
	__xamarin_class_map [224].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_SecondaryToolbarItem_SecondaryToolbarItemContent class];
	__xamarin_class_map [225].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_SecondaryToolbarItem class];
	__xamarin_class_map [226].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_DataSource class];
	__xamarin_class_map [227].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_SecondaryToolbar class];
	__xamarin_class_map [228].handle = [Xamarin_Forms_Platform_CarouselViewRenderer class];
	__xamarin_class_map [229].handle = [Xamarin_Forms_Platform_CarouselViewController_Layout class];
	__xamarin_class_map [230].handle = [Xamarin_Forms_Platform_CarouselViewController_Cell class];
	__xamarin_class_map [231].handle = [Xamarin_Forms_Platform_CarouselViewController class];
