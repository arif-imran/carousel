...
extern void *mono_aot_module_CustomerPortal_iOS_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_CustomerPortal_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CustomerPortal.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
